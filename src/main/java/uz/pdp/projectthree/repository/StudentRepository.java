...
public interface StudentRepository extends JpaRepository<Student, Integer> {
    ...
    Page<Student> findAllByGroup_FacultyId(Integer group_faculty_university_id, Pageable pageable);

    Page<Student> findAllByGroup_Id(Integer group_faculty_university_id, Pageable pageable);
